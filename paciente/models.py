...
class Paciente(models.Model):
    ...
    escolaridade = models.CharField(max_length=30, choices=[
    ...
    consome_bebida = models.CharField(max_length=3, choices=[
        ('nao', 'Não'),
        ('sim', 'Sim'),
    ])
    tipos_bebidas = models.CharField(max_length=20, choices=[
        ('fermentadas', 'Bebidas Fermentadas'),
        ('mistas', 'Bebidas Mistas'),
        ('destiladas', 'Bebidas Destiladas'),
    ], blank=True)
    quantidade_ingerida = models.CharField(max_length=20, choices=[
        ('1_a_3', '1 a 3 copos'),
        ('4_a_6', '4 a 6 copos'),
        ('7_a_9', '7 a 9 copos'),
    ...
    frequencia_uso = models.CharField(max_length=20, choices=[
    ...
    fumante = models.CharField(max_length=20, choices=[
        ('sim', 'Sim'),
        ('nao', 'Não'),
    ...
    atividades_fisicas = models.CharField(max_length=20, choices=[
        ('caminhar', 'Caminhar'),
        ('pedalar', 'Pedalar'),
        ('danca', 'Dança'),
    ...
    frequencia_atividade = models.CharField(max_length=20, choices=[
        ('todos_os_dias', 'Todos os dias'),
    ...
    outro_doenca = models.CharField(max_length=100, blank=True)  # Campo para "Outro"
    ...
    # Campo para sentir o que incomoda
    ...
    # Informações importantes sobre alergias, quedas e cirurgias
    ...
    # Justificativa para a percepção da saúde
